#!/usr/bin/env python3
"""
Тест Gemini сервиса с async и прокси
"""
...
async def test_gemini():
    print("=== Тест Gemini сервиса с async и прокси ===")

    # Тест инициализации
    try:
        success = await initialize_gemini_service()
        ...
        if success:
            ...
            print("\nТест распознавания изображения...")
            result = await service.recognize_product(img_bytes)
